...
namespace PoochWareHouse_Automation.Pages.PageElements
{
    public static class HeaderMenu
    {
        ...
        public static IWebElement News => Driver._webdriver.FindElement(By.XPath("//*[@id=\"SiteNav\"]/li[4]/a/span"));
        public static IWebElement AllProductsLink => Driver._webdriver.FindElement(By.XPath("//*[@id=\"SiteNav\"]/li[5]/a/span"));
